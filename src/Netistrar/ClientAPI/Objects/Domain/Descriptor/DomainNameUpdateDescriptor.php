...
class DomainNameUpdateDescriptor extends SerialisableObject {
    ...
    * @param  $privacyProxy
    */
    public function __construct($domainNames = null, $ownerContact = null, $adminContact = null, $billingContact = null, $technicalContact = null, $nameservers = null, $privacyProxy = null){
